...
namespace ArchiMind
{
    internal class JeuxInstruction
    {
        ...
        */
        ...
        public static void executer_simulation_phase_a_phase(string type_exec, string mnemonique, string format, bool mem_b, string mem, string valdepl, string source, Image? image = null, Image? image1 = null, bool ifdepl = false, string ccm = "", string val1 = "", string val2 = "", string val3 = "")
        {
            if (type_exec == "instruction")
            {
                //mem joue le role de destinataire
                Case case_memoire = new Case();
                string result = "";
                if (mem_b)
            ...
            }else{ //execution programme -- ne7iw les animations te3 la boule on laisse uniquement te3 les registres et les indicateurs.
            }
        }
    }
