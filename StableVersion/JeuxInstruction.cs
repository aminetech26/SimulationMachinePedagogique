...
namespace ArchiMind
{
    ...
    internal class JeuxInstruction
    {
        ...
        */
        ...
        public static async void format_ax_imm16(string mnemonique, string valAx, string valImmediate16, List<System.Windows.Controls.Image> Images)
        {
        ...
        public static async void format_reg16(string mnemonique, string reg, string valReg, List<System.Windows.Controls.Image> Images)
        {
            //inc , dec 
        ...
        public static async void format_reg16_imm16(string mnemonique, string reg, string valReg, string valImm16, List<System.Windows.Controls.Image> Images)
        {
            // ici je vais faire un petite bloc du code pour intialisé la 2eme case de la memoire par la valeur immidiate
            Case case_memoire = new Case();
            // case_memoire = MC.recherche_mc("0101");
           ...
           // setRiInFront("00000");
            ...
            switch (format)
            {
                ...
                case "Reg16,Reg16/mem16":
                    ...
                    break;
                case "AX,Reg16":
                    format_ax_reg(mnemonique, source, val1, val2, Images);
                    break;
                case "AX,imd16":
                    format_ax_imm16(mnemonique, val1, val3, Images);
                    break;
                case "Reg16":
                    format_reg16(mnemonique, source, val1, Images);
                    break;
                case "Reg16,imm16":
                    format_reg16_imm16(mnemonique, source, val1, val3, Images);
                    break;
                // mem16
                case "mem16":
                    //decodage -- delay
                ...
                case "Reg16/mem16":
                    if (mem_b)
                    {
                        ...
                        Animation.AnimateImage4(Images[21], Images[45], -490, 8, -480, -365, 1);
                        Animation.AnimateImage4(Images[22], Images[46], -490, 8, -480, -365, 1);
                        Animation.AnimateImage4(Images[23], Images[47], -490, 8, -480, -365, 1);
                        await Task.Delay(TimeSpan.FromSeconds(4));
                        string adresse = UAL.calculAdresse(mem, ifdepl, valdepl);
                        MC.setRam(adresse);
                        ...
                        switch (mnemonique)
                        {
                            case "INC":
                                ...
                                result = hexInt.ToString("X4").ToUpper();
                                JeuxInstruction.SetInt(result);
                                //UAL.positionnerIndicateurs("INC", Convert.ToString(Convert.ToInt32(result, 16), 2));
                                //animation (UAL,rim);
                                Animation.AnimateImage2(Images[43], Images[37], -1165, -30, -170, -100, 1);
                                Animation.AnimateImage2(Images[42], Images[36], -1165, -30, -170, -100, 1);
                                Animation.AnimateImage2(Images[44], Images[38], -1165, -30, -170, -100, 1);
                            ...
                            case "DEC":
                                ...
                                result = hexInt.ToString("X4").ToUpper();
                                JeuxInstruction.SetInt(result);
                               // UAL.positionnerIndicateurs("DEC", Convert.ToString(Convert.ToInt32(result, 16), 2));
                                //animation (UAL,rim);
                                Animation.AnimateImage2(Images[43], Images[37], -1165, -30, -170, -100, 1);
                                Animation.AnimateImage2(Images[42], Images[36], -1165, -30, -170, -100, 1);
                                Animation.AnimateImage2(Images[44], Images[38], -1165, -30, -170, -100, 1);
                            ...
                            case "MUL":
                                ...
                                //UAL.positionnerIndicateurs("MUL", Convert.ToString(Convert.ToInt32(hexResult, 16), 2));
                            ...
                            case "NOT":
                                ...
                                //UAL.positionnerIndicateurs("NOT", Convert.ToString(Convert.ToInt32(result, 16), 2));
                                //animation (UAL,rim);
                                Animation.AnimateImage2(Images[43], Images[37], -1165, -30, -170, -100, 1);
                                Animation.AnimateImage2(Images[42], Images[36], -1165, -30, -170, -100, 1);
                                Animation.AnimateImage2(Images[44], Images[38], -1165, -30, -170, -100, 1);
                ...
                case "Reg16/Mem16,imm16":
                    if (mem_b)
                    {
                        ...
                        //animation (Registres,RAM,adresse)
                        Animation.AnimateImage4(Images[23], Images[45], -490, 8, -480, -365, 1);
                        Animation.AnimateImage4(Images[23], Images[46], -490, 8, -480, -365, 1);
                        Animation.AnimateImage4(Images[23], Images[47], -490, 8, -480, -365, 1);
                        await Task.Delay(TimeSpan.FromSeconds(4));
                        string adresse = UAL.calculAdresse(mem, ifdepl, valdepl);
                        MC.setRam(adresse);
